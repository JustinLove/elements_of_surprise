function eos_test_player_spawned(player_entity)
	...
	eos_container('actual_'..'radioactive_liquid', x+1, y )
	eos_container('actual_'..'magic_liquid_worm_attractor', x+2, y )
	eos_container('actual_'..'magic_liquid_faster_levitation', x+3, y )
